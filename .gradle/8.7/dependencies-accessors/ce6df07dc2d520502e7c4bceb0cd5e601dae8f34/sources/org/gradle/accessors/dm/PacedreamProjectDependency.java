...
@NonNullApi
public class PacedreamProjectDependency extends DelegatingProjectDependency {

    @Inject
    public PacedreamProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
