...
public final class DatabaseModule_ProvidePropertyDaoFactory implements Factory<PropertyDao> {
  ...
  public DatabaseModule_ProvidePropertyDaoFactory(Provider<PaceDreamDatabase> databaseProvider) {
  ...
  public static PropertyDao providePropertyDao(PaceDreamDatabase database) {
